<script lang="ts">
  ...
  let activityLevel: "sedentary" | "light" | "moderate" | "active" | null =
    null;
...
<main class="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
  ...
  {:else}
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      >
        <h2
          class="text-xl font-bold mb-6 flex items-center gap-2 text-gray-800 dark:text-white"
        >
          <svg
      ...
      >
        ...
        {#if bmi}
          <div class="text-center mb-6">
            <div
              class="text-5xl font-bold mb-2 text-{getBmiClass(
                bmiCategory
              )}-600 dark:text-{getBmiClass(bmiCategory)}-400"
            >
              {bmi.toFixed(1)}
            </div>
          ...
          <div
            class="relative h-4 bg-gradient-to-r from-yellow-400 via-green-400 to-red-500 rounded-full mb-2"
          >
            <div
              class="absolute top-[-4px] w-3 h-6 bg-gray-900 dark:bg-gray-200 rounded-full transform -translate-x-1/2"
              style="left: {bmiPosition}%"
            ></div>
          </div>

          <div
            class="flex justify-between text-xs text-gray-600 dark:text-gray-400 px-2"
          >
            <span>16</span>
            <span>18.5</span>
            <span>25</span>
