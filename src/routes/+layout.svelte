  ...
  <div class="dark:bg-gray-900 min-h-screen font-inter transition-colors duration-200">
            ...
            <div class="flex flex-col space-y-4">
              ...
              <div class="pt-4 border-t dark:border-gray-700 flex items-center justify-between">
                <div class="flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <p class="text-gray-300 dark:text-gray-400 font-medium">{currentUser.displayName}</p>
                    <button
                      on:click={logout}
    ...
    <!-- Main Content -->
    <main class="container mx-auto px-4 py-8 dark:bg-gray-900 dark:text-gray-300 min-h-[calc(100vh-4rem)]">
      <slot />
    </main>
  </div>