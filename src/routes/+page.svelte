  ...
  <div
    class="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 font-inter transition-colors duration-300"
  >
    <!-- Animated Background -->
    <div class="absolute inset-0 opacity-20 dark:opacity-10">
      <div
        class="absolute w-96 h-96 bg-purple-200 dark:bg-purple-900 rounded-full blur-3xl opacity-40 -top-48 -left-48 animate-pulse"
      ></div>
      <div
        class="absolute w-96 h-96 bg-blue-200 dark:bg-blue-900 rounded-full blur-3xl opacity-40 -bottom-48 -right-48 animate-pulse"
      ></div>
    </div>
    ...
    <section class="relative pt-32 pb-24 px-6">
      <div class="max-w-7xl mx-auto text-center">
        ...
        >
          Smarter Health<br />
          <span class="text-3xl md:text-4xl text-gray-600 dark:text-gray-300"
            >Powered by AI</span
          >
        </h1>
        ...
        >
          Revolutionize your wellness journey with predictive analytics and
    ...
    <section class="py-20 bg-white dark:bg-gray-900 px-6">
      <div class="max-w-7xl mx-auto">
        <h2
          class="text-3xl font-bold text-center mb-16 text-gray-800 dark:text-white"
        >
    ...
    <!-- Stats -->
    <section
      class="py-20 bg-gradient-to-r from-blue-600 to-purple-500 dark:from-blue-700 dark:to-purple-600 text-white"
    >
      <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8 text-center">
        {#each stats as stat, i}
          <div transition:fly={{ y: 20, delay: i * 100 }} class="p-6">
